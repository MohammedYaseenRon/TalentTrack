...
const Modal = ({children, name, isOpen, onClose,width = "max-w-3xl"}: ModalProps) => {
    if(!isOpen) return null;
    return (
        <div className='fixed inset-0 z-50 flex justify-center items-center overflow-hidden bg-gray-300 bg-opacity-50 p-4'>
            <div className={`w-full ${width} h-[90vh] rounded-lg bg-white shadow-lg dark:bg-dark-secondary flex flex-col`}>
