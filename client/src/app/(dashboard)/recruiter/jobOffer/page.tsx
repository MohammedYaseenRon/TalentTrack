...
import { useJobStore } from '@/state/jobStore';
  ...
  const JobOffer = () => {
    const { jobs,applications,fetchingApplications,selectedJobId,loading,error,fetchJobs,fetchApplications,updateApplicationStatus,setSelectedJobId } = useJobStore();
    ...
    const handleStatusChange = (newStatus: string, applicationId: number) => {
